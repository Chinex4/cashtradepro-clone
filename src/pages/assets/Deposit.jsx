...
export default function Deposit() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className='max-w-5xl mx-auto p-4 md:p-6 lg:p-8 text-white'
    >
      ...
      <div className='mb-4'>
        ...
        <div className='relative'>
          <button
            ...
            style={{
              boxShadow: coinOpen ? '0 0 0 2px #C7F02D inset' : undefined,
            }}
          >
        ...
        <div className='mb-4'>
          ...
          <div className='relative'>
            <button
              ...
              className='w-full bg-[#161616] border border-gray-800 rounded-2xl px-4 py-4 flex items-center justify-between hover:border-gray-700 focus:outline-none'
              style={{
                boxShadow: netOpen ? '0 0 0 2px #C7F02D inset' : undefined,
              }}
            >
            ...
            <div className='flex items-center justify-between'>
              ...
              <div className='relative' ref={accountMenuRef}>
                ...
                >
                  {depositAccount}{' '}
                  <ChevronRight
                    className={`w-4 h-4 ${accountMenuOpen ? 'rotate-90' : ''}`}
                  />
                </button>
                ...
                {accountMenuOpen && (
                  <div className='absolute right-0 top-8 z-40 w=[320px] rounded-2xl bg-[#0f0f0f] border border-gray-800 shadow-2xl p-3'>
                    ...
                    >
                      <div className='text-[#C7F02D] font-semibold'>
                        Spot Account
                      </div>
                      <div className='text-gray-300 text-sm mt-1'>
                        As the default account, it can be used for spot trading,
                        withdrawal, etc.
                      </div>
                    ...
                    <div className='text-[13px] text-[#f59e0b] mt-3 px-3 pb-1'>
                      Assets can be transferred between accounts at zero cost at
                      any time.
                    </div>
                  </div>
                )}
